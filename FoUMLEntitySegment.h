#if !defined(FO_FOUMLENTITYSEGMENT_H__5690E038_E906_4FC8_8259_8C8A27B8AEF3__INCLUDED_)
#define FO_FOUMLENTITYSEGMENT_H__5690E038_E906_4FC8_8259_8C8A27B8AEF3__INCLUDED_
...
#define ID_FOP_SAMPLE_UML_SEGMENT		FO_COMP_CUSTOM+2

 
//===========================================================================
// Summary:
//     The CFoUMLEntitySegment class derived from CFODrawPortsShape
//      Fo U M L Entity Segment
//===========================================================================

class CFoUMLEntitySegment : public CFODrawPortsShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFoUMLEntitySegment---Fo U M L Entity Segment, Specifies a CFoUMLEntitySegment object.
	DECLARE_SERIAL(CFoUMLEntitySegment);
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Set Entity Type, Sets a specify value to current class CFoUMLEntitySegment
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Fo U M L Entity Segment, Constructs a CFoUMLEntitySegment object.
	//		Returns A  value.
	CFoUMLEntitySegment();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFoUMLEntitySegment& src object.
	CFoUMLEntitySegment(const CFoUMLEntitySegment& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C Fo U M L Entity Segment, Destructor of class CFoUMLEntitySegment
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFoUMLEntitySegment();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFoUMLEntitySegment object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	// Parameters:
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A CFoUMLEntitySegment& value.  
	// Parameters:
	//		src---Specifies a const CFoUMLEntitySegment& src object.
	CFoUMLEntitySegment& operator=(const CFoUMLEntitySegment& src);
...
#endif // !defined(FO_FOUMLENTITYSEGMENT_H__5690E038_E906_4FC8_8259_8C8A27B8AEF3__INCLUDED_)
