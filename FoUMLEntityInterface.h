#if !defined(FO_FOUMLENTITYINTERFACE_H__ACBF2971_9D84_4D3A_A4CC_870088943B05__INCLUDED_)
#define FO_FOUMLENTITYINTERFACE_H__ACBF2971_9D84_4D3A_A4CC_870088943B05__INCLUDED_
...
#define ID_FOP_SAMPLE_UML_INTERFACE		FO_COMP_CUSTOM+6

 
//===========================================================================
// Summary:
//     The CFoUMLEntityInterface class derived from CFODrawPortsShape
//      Fo U M L Entity Interface
//===========================================================================

class CFoUMLEntityInterface : public CFODrawPortsShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFoUMLEntityInterface---Fo U M L Entity Interface, Specifies a CFoUMLEntityInterface object.
	DECLARE_SERIAL(CFoUMLEntityInterface);
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Set Entity Type, Sets a specify value to current class CFoUMLEntityInterface
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Fo U M L Entity Interface, Constructs a CFoUMLEntityInterface object.
	//		Returns A  value.
	CFoUMLEntityInterface();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFoUMLEntityInterface& src object.
	CFoUMLEntityInterface(const CFoUMLEntityInterface& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C Fo U M L Entity Interface, Destructor of class CFoUMLEntityInterface
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFoUMLEntityInterface();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFoUMLEntityInterface object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	// Parameters:
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A CFoUMLEntityInterface& value.  
	// Parameters:
	//		src---Specifies a const CFoUMLEntityInterface& src object.
	CFoUMLEntityInterface& operator=(const CFoUMLEntityInterface& src);
...
#endif // !defined(FO_FOUMLENTITYINTERFACE_H__ACBF2971_9D84_4D3A_A4CC_870088943B05__INCLUDED_)
