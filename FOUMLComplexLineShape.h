#if !defined(FO_FOUMLCOMPLEXLINESHAPE_H__3D5E1438_63DC_45E7_A13E_25D737B350D0__INCLUDED_)
#define FO_FOUMLCOMPLEXLINESHAPE_H__3D5E1438_63DC_45E7_A13E_25D737B350D0__INCLUDED_
...
// Author: Author Name.
//------------------------------------------------------
#define ID_FOP_SAMPLE_COMPLEX_LINE		FO_COMP_CUSTOM+17

 
//===========================================================================
// Summary:
//     The CFOUMLComplexLineShape class derived from CFORoundTurnCornerLinkShape
//      F O U M L Complex Line Shape
//===========================================================================

class CFOUMLComplexLineShape : public CFORoundTurnCornerLinkShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFOUMLComplexLineShape---F O U M L Complex Line Shape, Specifies a E-XD++ CFOUMLComplexLineShape object.
	DECLARE_SERIAL(CFOUMLComplexLineShape);
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// F O U M L Complex Line Shape, Constructs a CFOUMLComplexLineShape object.
	//		Returns A  value.
	CFOUMLComplexLineShape();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFOUMLComplexLineShape& src object.
	CFOUMLComplexLineShape(const CFOUMLComplexLineShape& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C F O U M L Complex Line Shape, Destructor of class CFOUMLComplexLineShape
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFOUMLComplexLineShape();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFOUMLComplexLineShape object in two steps. First call the constructor, then call Create, which creates the object.
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A E-XD++ CFOUMLComplexLineShape& value.  
	// Parameters:
	//		src---Specifies a const CFOUMLComplexLineShape& src object.
	CFOUMLComplexLineShape& operator=(const CFOUMLComplexLineShape& src);
...
#endif // !defined(FO_FOUMLCOMPLEXLINESHAPE_H__3D5E1438_63DC_45E7_A13E_25D737B350D0__INCLUDED_)
