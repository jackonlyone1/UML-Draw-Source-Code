// FoUMLEntityTemplate.cpp : Defines the class behaviors for the application.
//
...
//////////////////////////////////////////////////////////////////////
// CFoUMLEntityTemplate Class
// Construction/Destruction
//////////////////////////////////////////////////////////////////////
IMPLEMENT_SERIAL(CFoUMLEntityTemplate, CFODrawPortsShape, 0)
CFoUMLEntityTemplate::CFoUMLEntityTemplate()
{
	//SetType(You own ID here); you must asign a new ID for this control.
	SetType(ID_FOP_SAMPLE_UML_TEMPLATE);
	SetPatternColor(RGB(0,160,196));
	SetWithLabelEditing(FALSE);
	SetRotateProtect(TRUE);
	SetLineWidth(2);

	m_umlEntity = UMLEntityClassTemplate;
	m_pEntityClass = new CUMLEntityClassTemplate;
}

CFoUMLEntityTemplate::CFoUMLEntityTemplate(const CFoUMLEntityTemplate& src)
{
	*this = src;
}
...
/////////////////////////////////////////////////////////////////////////////
// CFoUMLEntityTemplate diagnostics

#ifdef _DEBUG
void CFoUMLEntityTemplate::AssertValid() const
{
	CFODrawPortsShape::AssertValid();
}

void CFoUMLEntityTemplate::Dump(CDumpContext& dc) const
{
...
void CFoUMLEntityTemplate::Create(CRect &rcPos,CString strCaption)
{
// Example code:
	AllocMemory(4);
...
void CFoUMLEntityTemplate::Serialize(CArchive& ar)
{
...
CFile* CFoUMLEntityTemplate::GetFile(LPCTSTR lpszFileName, UINT nOpenFlags,
...
void CFoUMLEntityTemplate::ReleaseFile(CFile* pFile, BOOL bAbort)
{
...
BOOL CFoUMLEntityTemplate::OpenDocument(LPCTSTR lpszPathName)
{
...
BOOL CFoUMLEntityTemplate::SaveDocument(LPCTSTR lpszPathName)
{
...
CFoUMLEntityTemplate& CFoUMLEntityTemplate::operator=(const CFoUMLEntityTemplate& src)
{
...
CFODrawShape* CFoUMLEntityTemplate::Copy() const
{
	return (new CFoUMLEntityTemplate(*this));
}

void CFoUMLEntityTemplate::PrepareDC(CDC* pDC)
{
...
void CFoUMLEntityTemplate::GetPathSimplePolygon(FOPSimpleCompositePolygon& rPoly) const
{
	CFODrawPortsShape::GetPathSimplePolygon(rPoly);

}

void CFoUMLEntityTemplate::OnDrawTrackCustom(CDC *pDC)
{
...
void CFoUMLEntityTemplate::DoDrawVisioOrderLine(CDC *pDC)
{
...
void CFoUMLEntityTemplate::OnDrawFlat(CDC *pDC)
{
...
void CFoUMLEntityTemplate::OnDrawShadow(CDC *pDC)
{
...
void CFoUMLEntityTemplate::OnDraw3d(CDC *pDC)
{
...
void CFoUMLEntityTemplate::ClearDC(CDC* pDC)
{
...
void CFoUMLEntityTemplate::GeometryUpdated(CFOArea* pRgn)
{
// Example code:
...
void CFoUMLEntityTemplate::SetEntityType(const FOP_UML_ENTITY &umlEntity)
{
