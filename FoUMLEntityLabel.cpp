// FoUMLEntityLabel.cpp : Defines the class behaviors for the application.
//
...
//////////////////////////////////////////////////////////////////////
// CFoUMLEntityLabel Class
// Construction/Destruction
//////////////////////////////////////////////////////////////////////
IMPLEMENT_SERIAL(CFoUMLEntityLabel, CFODrawPortsShape, 0)
CFoUMLEntityLabel::CFoUMLEntityLabel()
{
	//SetType(You own ID here); you must asign a new ID for this control.
	SetType(ID_FOP_SAMPLE_UML_LABEL);
	SetPatternColor(RGB(0,160,196));
	SetWithLabelEditing(FALSE);
	SetRotateProtect(TRUE);

	m_umlEntity = UMLEntityLabel;
	m_pEntityClass = new CUMLEntityLabel;
}

CFoUMLEntityLabel::CFoUMLEntityLabel(const CFoUMLEntityLabel& src)
{
	*this = src;
}
...
/////////////////////////////////////////////////////////////////////////////
// CFoUMLEntityLabel diagnostics

#ifdef _DEBUG
void CFoUMLEntityLabel::AssertValid() const
{
	CFODrawPortsShape::AssertValid();
}

void CFoUMLEntityLabel::Dump(CDumpContext& dc) const
{
...
void CFoUMLEntityLabel::Create(CRect &rcPos,CString strCaption)
{
// Example code:
	AllocMemory(4);
...
void CFoUMLEntityLabel::Serialize(CArchive& ar)
{
...
CFile* CFoUMLEntityLabel::GetFile(LPCTSTR lpszFileName, UINT nOpenFlags,
...
void CFoUMLEntityLabel::ReleaseFile(CFile* pFile, BOOL bAbort)
{
...
BOOL CFoUMLEntityLabel::OpenDocument(LPCTSTR lpszPathName)
{
...
BOOL CFoUMLEntityLabel::SaveDocument(LPCTSTR lpszPathName)
{
...
CFoUMLEntityLabel& CFoUMLEntityLabel::operator=(const CFoUMLEntityLabel& src)
{
...
CFODrawShape* CFoUMLEntityLabel::Copy() const
{
	return (new CFoUMLEntityLabel(*this));
}

void CFoUMLEntityLabel::PrepareDC(CDC* pDC)
{
...
void CFoUMLEntityLabel::GetPathSimplePolygon(FOPSimpleCompositePolygon& rPoly) const
{
	CFODrawPortsShape::GetPathSimplePolygon(rPoly);

}

void CFoUMLEntityLabel::OnDrawTrackCustom(CDC *pDC)
{
...
void CFoUMLEntityLabel::DoDrawVisioOrderLine(CDC *pDC)
{
...
void CFoUMLEntityLabel::OnDrawFlat(CDC *pDC)
{
...
void CFoUMLEntityLabel::OnDrawShadow(CDC *pDC)
{
...
void CFoUMLEntityLabel::OnDraw3d(CDC *pDC)
{
...
void CFoUMLEntityLabel::ClearDC(CDC* pDC)
{
...
void CFoUMLEntityLabel::GeometryUpdated(CFOArea* pRgn)
{
// Example code:
...
void CFoUMLEntityLabel::SetEntityType(const FOP_UML_ENTITY &umlEntity)
{
