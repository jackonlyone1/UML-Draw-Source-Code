#if !defined(FO_FOUMLCONTROLLINESHAPE_H__98C738D5_0109_4ABF_8CCD_7F0EE89921D1__INCLUDED_)
#define FO_FOUMLCONTROLLINESHAPE_H__98C738D5_0109_4ABF_8CCD_7F0EE89921D1__INCLUDED_
...
// Author: Author.
//------------------------------------------------------
#define ID_FOP_SAMPLE_UML_CONTROL_LINE		FO_COMP_CUSTOM+10

 
//===========================================================================
// Summary:
//     The CFOUMLControlLineShape class derived from CFORoundTurnCornerLinkShape
//      F O U M L  Line Shape
//===========================================================================

class CFOUMLControlLineShape : public CFORoundTurnCornerLinkShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFOUMLControlLineShape---F O U M L  Line Shape, Specifies a E-XD++ CFOUMLControlLineShape object.
	DECLARE_SERIAL(CFOUMLControlLineShape);
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// F O U M L  Line Shape, Constructs a CFOUMLControlLineShape object.
	//		Returns A  value.
	CFOUMLControlLineShape();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFOUMLControlLineShape& src object.
	CFOUMLControlLineShape(const CFOUMLControlLineShape& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C F O U M L  Line Shape, Destructor of class CFOUMLControlLineShape
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFOUMLControlLineShape();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFOUMLControlLineShape object in two steps. First call the constructor, then call Create, which creates the object.
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A E-XD++ CFOUMLControlLineShape& value.  
	// Parameters:
	//		src---Specifies a const CFOUMLControlLineShape& src object.
	CFOUMLControlLineShape& operator=(const CFOUMLControlLineShape& src);
...
#endif // !defined(FO_FOUMLCONTROLLINESHAPE_H__98C738D5_0109_4ABF_8CCD_7F0EE89921D1__INCLUDED_)
