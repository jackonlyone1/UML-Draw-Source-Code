#if !defined(FO_FOUMLENTITYPACKAGE_H__49EE018B_2DB5_46EC_AE4D_A8DB76CE8AF8__INCLUDED_)
#define FO_FOUMLENTITYPACKAGE_H__49EE018B_2DB5_46EC_AE4D_A8DB76CE8AF8__INCLUDED_
...
#define ID_FOP_SAMPLE_UML_PACKAGE		FO_COMP_CUSTOM+3

 
//===========================================================================
// Summary:
//     The CFoUMLEntityPackage class derived from CFODrawPortsShape
//      Fo U M L Entity Package
//===========================================================================

class CFoUMLEntityPackage : public CFODrawPortsShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFoUMLEntityPackage---Fo U M L Entity Package, Specifies a CFoUMLEntityPackage object.
	DECLARE_SERIAL(CFoUMLEntityPackage);
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Set Entity Type, Sets a specify value to current class CFoUMLEntityPackage
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Fo U M L Entity Package, Constructs a CFoUMLEntityPackage object.
	//		Returns A  value.
	CFoUMLEntityPackage();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFoUMLEntityPackage& src object.
	CFoUMLEntityPackage(const CFoUMLEntityPackage& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C Fo U M L Entity Package, Destructor of class CFoUMLEntityPackage
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFoUMLEntityPackage();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFoUMLEntityPackage object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	// Parameters:
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A CFoUMLEntityPackage& value.  
	// Parameters:
	//		src---Specifies a const CFoUMLEntityPackage& src object.
	CFoUMLEntityPackage& operator=(const CFoUMLEntityPackage& src);
...
#endif // !defined(FO_FOUMLENTITYPACKAGE_H__49EE018B_2DB5_46EC_AE4D_A8DB76CE8AF8__INCLUDED_)
