#if !defined(FO_FONORMALSTATESHAPE_H__9085264D_997B_4129_9672_6B0A475C1A6C__INCLUDED_)
#define FO_FONORMALSTATESHAPE_H__9085264D_997B_4129_9672_6B0A475C1A6C__INCLUDED_
...
// Author: Author Name.
//------------------------------------------------------
#define ID_FOP_SAMPLE_UML_NORMAL_STATE		FO_COMP_CUSTOM+9

 
//===========================================================================
// Summary:
//     The CFONormalStateShape class derived from CFORoundRectShape
//      F O Normal State Shape
//===========================================================================

class CFONormalStateShape : public CFORoundRectShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFONormalStateShape---F O Normal State Shape, Specifies a E-XD++ CFONormalStateShape object.
	DECLARE_SERIAL(CFONormalStateShape);
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// F O Normal State Shape, Constructs a CFONormalStateShape object.
	//		Returns A  value.
	CFONormalStateShape();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFONormalStateShape& src object.
	CFONormalStateShape(const CFONormalStateShape& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C F O Normal State Shape, Destructor of class CFONormalStateShape
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFONormalStateShape();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFONormalStateShape object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	// Parameters:
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A E-XD++ CFONormalStateShape& value.  
	// Parameters:
	//		src---Specifies a const CFONormalStateShape& src object.
	CFONormalStateShape& operator=(const CFONormalStateShape& src);
...
#endif // !defined(FO_FONORMALSTATESHAPE_H__9085264D_997B_4129_9672_6B0A475C1A6C__INCLUDED_)
