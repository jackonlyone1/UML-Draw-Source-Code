#if !defined(FO_FOUMLENDSHAPE_H__1ECE25AC_0FDF_443B_8B3B_BE3FE203DC02__INCLUDED_)
#define FO_FOUMLENDSHAPE_H__1ECE25AC_0FDF_443B_8B3B_BE3FE203DC02__INCLUDED_
...
// Author: Author.
//------------------------------------------------------
#define	EXT_END_SHAPE FO_COMP_CUSTOM + 15

 
//===========================================================================
// Summary:
//     The CFOUMLEndShape class derived from CFOEllipseShape
//      F O U M L End Shape
//===========================================================================

class CFOUMLEndShape : public CFOEllipseShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CFOUMLEndShape---F O U M L End Shape, Specifies a E-XD++ CFOUMLEndShape object.
	DECLARE_SERIAL(CFOUMLEndShape);
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// F O U M L End Shape, Constructs a CFOUMLEndShape object.
	//		Returns A  value.
	CFOUMLEndShape();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CFOUMLEndShape& src object.
	CFOUMLEndShape(const CFOUMLEndShape& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C F O U M L End Shape, Destructor of class CFOUMLEndShape
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CFOUMLEndShape();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CFOUMLEndShape object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	// Parameters:
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A E-XD++ CFOUMLEndShape& value.  
	// Parameters:
	//		src---Specifies a const CFOUMLEndShape& src object.
	CFOUMLEndShape& operator=(const CFOUMLEndShape& src);
...
#endif // !defined(FO_FOUMLENDSHAPE_H__1ECE25AC_0FDF_443B_8B3B_BE3FE203DC02__INCLUDED_)
