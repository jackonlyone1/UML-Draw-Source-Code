#if !defined(FO_EXTACTORSHAPE_H__1E437020_F0A3_41D3_898C_C4BD52EBE8EE__INCLUDED_)
#define FO_EXTACTORSHAPE_H__1E437020_F0A3_41D3_898C_C4BD52EBE8EE__INCLUDED_
...
// Author: Author Name.
//------------------------------------------------------
#define EXT_ACTOR_SHAPE	FO_COMP_CUSTOM + 13

 
//===========================================================================
// Summary:
//     The CExtActorShape class derived from CFODrawPortsShape
//      Extend Actor Shape
//===========================================================================

class CExtActorShape : public CFODrawPortsShape  
{
protected:
	...
	//		Returns A  value.  
	// Parameters:
	//		CExtActorShape---Extend Actor Shape, Specifies a CExtActorShape object.
	DECLARE_SERIAL(CExtActorShape);
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Extend Actor Shape, Constructs a CExtActorShape object.
	//		Returns A  value.
	CExtActorShape();
	...
	//		Returns A  value.  
	// Parameters:
	//		src---Specifies a const CExtActorShape& src object.
	CExtActorShape(const CExtActorShape& src);

	// Destructor.
	
	//-----------------------------------------------------------------------
	// Summary:
	// C Extend Actor Shape, Destructor of class CExtActorShape
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CExtActorShape();

	
	//-----------------------------------------------------------------------
	// Summary:
	// You construct a CExtActorShape object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	// Parameters:
...
public:
	...
	// Summary:
	// None Description.
	//		Returns A CExtActorShape& value.  
	// Parameters:
	//		src---Specifies a const CExtActorShape& src object.
	CExtActorShape& operator=(const CExtActorShape& src);
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Create Text Array, You construct a CExtActorShape object in two steps. First call the constructor, then call Create, which creates the object.
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns a int type value.  
	// Parameters:
	//		pDC---D C, A pointer to the CDC or NULL if the call failed.  
	//		strText---Text, Specifies A CString type value.  
	//		rcBox---Box, Specifies A CRect type value.  
	//		arLines---Lines, Specifies A CString type value.
...
#endif // !defined(FO_EXTACTORSHAPE_H__1E437020_F0A3_41D3_898C_C4BD52EBE8EE__INCLUDED_)
